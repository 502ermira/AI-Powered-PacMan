...
background = pygame.image.load("assets/images/gridbackground.png").convert()
coin = pygame.image.load("assets/images/nomdot.png").convert()
coin.set_colorkey(BLACK)
cells = init_grid("assets/images/gridbackground.png")
