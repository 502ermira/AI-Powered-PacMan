...
class PacMan(pygame.sprite.Sprite):
    ...
    def draw(self, screen):
        if self.dir == 'r': # moving right
            self.image = pygame.image.load("assets/images/pacmanright.png").convert()
        elif self.dir == 'l': # moving left
            self.image = pygame.image.load("assets/images/pacmanleft.png").convert()
        elif self.dir == 'd': # moving down
            self.image = pygame.image.load("assets/images/pacmandown.png").convert()
        elif self.dir == 'u': # moving up
            self.image = pygame.image.load("assets/images/pacmanup.png").convert()
